...
########################################################################
# heatmap simulazione: confronto EFA vs NMF
setwd("/Users/laura/Desktop/post/2 nmf/R")
...
# ============================
nmf_loadings_sim <- Psim_norm  # matrice NMF normalizzata
...
dev.copy(png, filename = "images/heatmaps_sim_EFA-NMF.png", width = 1400, height = 900, res = 150)
dev.off()
dev.off()
