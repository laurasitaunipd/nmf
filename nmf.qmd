...
**Recent models:** dimensional and transdiagnostic approaches, network of symptoms
...
-   Dataset of ordinal data (e.g. on a Likert scale)

-   Estimate **latent factors** through **factor analysis** and **NMF**

-   Compare the results using the correlation matrix of factor loadings
...
how to make the NMF recognize that structure within a questionaire (item-> factor)... confirmatoryNMF?
