---
title: "Causal Inference for Latent Factors<br> Underlying Psychopathology"
authors: "Laura Sità"
format:
  revealjs:
    center: true
...
- Compare them with those obtained through **CFA?**
...
- <span style="color:#900000;">Third step:</span> use NMF to find latent factors shared within the same spectrum of symptoms 

- <span style="color:#900000;">Fourth step:</span> use causal NMF to find latent factors across different treatment on the same spectrum of symptoms
